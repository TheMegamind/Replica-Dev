...
def playFavoriteByName(favoriteName) {
    ...
    sendCommand("playFavoriteByName",selectedFavorite.id)
...
def playRandomFavorite() {
    ...
    sendCommand("playRandomFavorite",favoriteId)
